...
const objLoader = (BABYLON) => {
  ...
  var OBJFileLoader = /** @class */ (function () {
    function OBJFileLoader() {
      ...
      this.vertexPatternMesh = /v( +[\d|\.|\+|\-|e|E]+)( +[\d|\.|\+|\-|e|E]+)( +[\d|\.|\+|\-|e|E]+)( +[\d|\.|\+|\-|e|E]+)( +[\d|\.|\+|\-|e|E]+)( +[\d|\.|\+|\-|e|E]+)/;
    ...
    OBJFileLoader.prototype._parseSolid = function (meshesNames, scene, data, rootUrl) {
      ...
      var wrappedColorForBabylon = []; //The list of position in vectors
      ...
      var unwrappedColorsForBabylon = []; //Value of positionForBabylon w/o Vector3() [x,y,z]
       ...
       */
      var setData = function (indicePositionFromObj, indiceUvsFromObj, indiceNormalFromObj, positionVectorFromOBJ, textureVectorFromOBJ, normalsVectorFromOBJ, colorVectorFromOBJ) {
        ...
        if (_index == -1) {
          ...
          wrappedColorForBabylon.push(colorVectorFromOBJ);
      ...
      var unwrapData = function () {
        ...
        for (var l = 0; l < wrappedPositionForBabylon.length; l++) {
          ...
          unwrappedColorsForBabylon.push(wrappedColorForBabylon[l].r, wrappedColorForBabylon[l].g, wrappedColorForBabylon[l].b, 1);
          unwrappedNormalsForBabylon.push(wrappedNormalsForBabylon[l].x, wrappedNormalsForBabylon[l].y, wrappedNormalsForBabylon[l].z);
          unwrappedUVForBabylon.push(wrappedUvsForBabylon[l].x, wrappedUvsForBabylon[l].y); //z is an optional value not supported by BABYLON
        }
        // Reset arrays for the next new meshes
        wrappedPositionForBabylon = [];
        wrappedColorForBabylon = [];
      ...
      var setDataForCurrentFaceWithPattern4 = function (face, v) {
        ...
        for (var k = 0; k < triangles.length; k++) {
          ...
          setData(indicePositionFromObj, 1, //Default value for uv
            ...
            BABYLON.Vector2.Zero(), normals[indiceNormalFromObj], colors[indicePositionFromObj],);
        }
        //Reset variable for the next line
        triangles = [];
      };
      ...
      for (var i = 0; i < lines.length; i++) {
        ...
        if (line.length === 0 || line.charAt(0) === '#') {
        ...
        else if ((result = this.vertexPatternMesh.exec(line)) !== null) {
          ...
          colors.push(new BABYLON.Color4(parseFloat(result[4]), parseFloat(result[5]), parseFloat(result[6]), 1))
